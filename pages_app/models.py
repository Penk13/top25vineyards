...
class ContentPage(models.Model):
    ...
    content = RichTextUploadingField(blank=True, verbose_name="Header Content")
    additional_content = RichTextUploadingField(blank=True, verbose_name="Main Content")
    content_on_list = RichTextUploadingField(blank=True, verbose_name="List Content")
